...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
    ...
    <p class="text-gray-600 mb-6">Contact our Customer service, for more information and details about your delivery!</p>

    <a href="https://wa.me/{{config('services.contact.whatsapp')}}" class="inline-block bg-green-700 hover:bg-green-800 text-white font-medium py-2 px-6 rounded-full transition duration-300">
